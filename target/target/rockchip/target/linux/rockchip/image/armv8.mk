...
define Device/ariaboard_photonicat
  ...
  DEVICE_PACKAGES := kmod-ath10k-sdio ath10k-firmware-qca9377-sdio wpad-basic-mbedtls \
...
define Device/armsom_sige3
  ...
  BOOT_FLOW := pine64-img
  DEVICE_PACKAGES := kmod-brcmfmac kmod-r8125 wpad-basic-mbedtls \
...
define Device/cyber_cyber3588-aib
  ...
  SOC := rk3588
  BOOT_FLOW := pine64-img
  DEVICE_PACKAGES := kmod-ata-ahci-dwc kmod-r8125 kmod-mt7921e wpad-basic-mbedtls \
        kmod-usb-net-cdc-mbim kmod-usb-net-qmi-wwan kmod-usb-serial-option uqmi
endef
...
define Device/firefly_roc-rk3568-pc
  ...
  BOOT_FLOW := pine64-img
  DEVICE_PACKAGES := kmod-ata-ahci-dwc kmod-brcmfmac wpad-basic-mbedtls \
	brcmfmac-firmware-43752-sdio brcmfmac-nvram-43752-sdio
endef
...
define Device/friendlyarm_nanopi-r5c
  ...
  SOC := rk3568
  BOOT_FLOW := pine64-img
  DEVICE_PACKAGES := kmod-r8125 kmod-rtw88-8822ce rtl8822ce-firmware wpad-basic-mbedtls
endef
...
define Device/lyt_t68m
  ...
  BOOT_FLOW := pine64-img
  DEVICE_PACKAGES := kmod-r8125 kmod-mt7921e wpad-basic-mbedtls
endef
