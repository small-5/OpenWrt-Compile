...
function formatSpeed(speed, duplex) {
	if (speed && duplex) {
		var d = (duplex == 'half') ? '\u202f(H)' : '',
		    e = (duplex == 'half') ? E('span', { 'title': _('Speed: %d Mbps Half-Duplex').format(speed) }) : E('span', { 'title': _('Speed: %d Mbps Full-Duplex').format(speed) });;

		switch (speed) {
		case 10:    e.innerText = '10\u202fMbps' + d;  break;
		case 100:   e.innerText = '100\u202fMbps' + d; break;
		case 1000:  e.innerText = '1\u202fGbps' + d; break;
		case 2500:  e.innerText = '2.5\u202fGbps';   break;
		case 5000:  e.innerText = '5\u202fGbps';     break;
		case 10000: e.innerText = '10\u202fGbps';    break;
		case 25000: e.innerText = '25\u202fGbps';    break;
		case 40000: e.innerText = '40\u202fGbps';    break;
		default:    e.innerText = '%d\u202fMbps%s'.format(speed, d);
		}
...
function renderNetworksTooltip(pmap) {
	...
	if (res.length > 1)
		res[0] = N_((res.length - 1) / 2, _('Part of network:'), _('Part of networks:'));
	else
