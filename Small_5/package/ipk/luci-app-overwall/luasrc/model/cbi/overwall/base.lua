...
o=s:option(Value,"dns",translate("Foreign DoT"),
translate("Custom DNS format:<br/>one.one.one.one -tls-host-verify one.one.one.one or dns.google -tls-host-verify dns.google -host-ip 8.8.8.8"))
o:value("","Cloudflare")
